...
## 1. Introduction and main results {#introduction}

### 1.1. The equation and its normalisation {#problem}
...
### 1.3. The arithmetic mechanism {#strategy}
...
### 1.4. Related work and organisation {#related-work}
...
## 2. Recurrence identities and the local analysis at 2 {#recurrence}

### 2.1. Dickson normalisation {#dickson}
...
### 2.2. Conjugate powers and doubling {#doubling}
...
### 2.3. Proof of Theorem 1.3 {#proof-even}
...
### 2.4. The complete odd-index phase split {#odd-phases}
...
## 3. A common Hilbert-reciprocity criterion {#criterion}

### 3.1. Conventions and the product obstruction {#local-global}
...
### 3.2. The fixed-field criterion {#monogenic-criterion}
...
### 3.3. Norm and supporting primes {#valuation-transfer}
...
### 3.4. The symbols away from 2 {#neutrality}
...
### 3.5. Stability of the dyadic squareclass {#hensel}
...
## 4. The two fixed-field certificates {#fixed-fields}

### 4.1. Shared field data {#field-data}
...
### 4.3. The degree-17 unit {#detector17}
...
### 4.4. The degree-41 unit {#detector41}
...
### 4.5. Dyadic primes and the hard-phase theorem {#dyadic-data}
...
## 5. Phase strengthening and assembly {#propagation}

### 5.1. Proof of Theorem 1.2 {#proof-fixed}
...
### 5.2. Odd-inner-index composition {#composition}

::: {.theorem #lem-composition}
...
### 5.3. Proof of Theorem 1.1 {#proof-main}
...
## 6. Pell coordinates and the powerful-number application {#pell}

### 6.1. Proof of Corollary 1.4 {#pell-coordinate}
...
### 6.2. The complete negative-Pell normal form {#source-normal-form}
...
### 6.3. The divisibility rank and the three sectors {#rank}
...
## 7. The integer-Jacobi certificate and formal realisation {#jacobi-formal}

### 7.1. The uniform character identity {#jacobi}
...
### 7.2. What the character says locally {#local-consequence}
...
### 7.3. Formal arithmetic and finite computation {#verification}
...
## 8. Mathematical scope {#conclusion}
...
## Appendix A. Reference arithmetic for the finite certificates {#reference-arithmetic}

### A.1. Reference characters {#reference-characters}
...
### A.2. Maximality and dyadic prime structure {#index-certificate}
...
## Appendix B. Compact proof and verification concordance {#verification-concordance}
...
## Appendix C. A compact exact-arithmetic verifier {#standalone-verifier}
